...
This script reads in stats about the premier league, and sorts them into panda dataframes,
...
for i in range(np.size(team_urls)):
    ...
    #test writing out df to csv
    os.makedirs('/Users/tom/Documents/python/football/team_stats/', exist_ok=True)  
    matches[0].to_csv('/Users/tom/Documents/python/football/team_stats/'+team_names[i]+'.csv')
