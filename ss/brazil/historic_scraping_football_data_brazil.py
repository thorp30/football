...
# -*- coding: utf-8 -*-
"""
Created on Tue May  2 21:27:34 2023
...
This script is used to scrape historic seasonal data.
...
# Historic year to scrape:
year = '2021'

# Defining the url of the website, directing to league specific stats tab.
url = "https://fbref.com/en/comps/24/"+year+"/"+year+"-Serie-A-Stats"
...
for i in range(np.size(team_urls)):
    temp = team_urls[i].split("/")[-3].replace("-Stats", "")
...
for i in np.arange(0,5):   
    ...
    #Shooting stats
    temp_shooting = pd.read_html("https://fbref.com/en/squads/"+squad_team[i][0]+"/"+year+"/matchlogs/all_comps/shooting/"+squad_team[i][1]+"-Match-Logs-All-Competitions")[0]
    ...
    #Passing Stats 
    temp_pass = pd.read_html("https://fbref.com/en/squads/"+squad_team[i][0]+"/"+year+"/matchlogs/all_comps/passing/"+squad_team[i][1]+"-Match-Logs-All-Competitions")[0]
    ...
    #Possession Stats   
    temp_poss = pd.read_html("https://fbref.com/en/squads/"+squad_team[i][0]+"/"+year+"/matchlogs/all_comps/possession/"+squad_team[i][1]+"-Match-Logs-All-Competitions")[0]
    ...
    #Misc Stats  
    temp_misc = pd.read_html("https://fbref.com/en/squads/"+squad_team[i][0]+"/"+year+"/matchlogs/all_comps/misc/"+squad_team[i][1]+"-Match-Logs-All-Competitions")[0]
    ...
    #Def Stats  
    temp_defence = pd.read_html("https://fbref.com/en/squads/"+squad_team[i][0]+"/"+year+"/matchlogs/all_comps/defense/"+squad_team[i][1]+"-Match-Logs-All-Competitions")[0]
...
match_df.to_csv('/Users/tom/Documents/python/football/brazil/brazil_matches_'+year+'.csv') #append today's date
