...
#Bring in this weeks games (created externally) from the fixtures csv file with today's date appended to file name
today = date.today()
future_fixtures = pd.read_csv('/Users/tom/Documents/python/football/football_ML/england/fixtures_{}.csv'.format(today))
...
final_predictions.to_csv("/Users/tom/Documents/python/football/football_ML/england/predictions_csv/final_predictions_"+str(today)+".csv", index = False)
